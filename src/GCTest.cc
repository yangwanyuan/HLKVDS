...
//}
//
//void Insert(kvdb::DB *db, char key_word)
//{
//    int key_len;
//    int value_len;
//    for (int index = 0; index < TEST_RECORD_NUM; index++)
...
//        key_len = key.length();
//        std::string temp1 = "Begin" + key + "End";
//        std::string temp2(4096 - temp1.length(), key_word);
//        std::string value = temp1 + temp2;
//        value_len = value.length();
//        db->Insert(key.c_str(), key_len, value.c_str(), value_len);
//        std::cout << "Insert Item Success. key = " << key << " ,value = " << value << " ,value_size = " << value_len << std::endl;
//    }
//}
//
